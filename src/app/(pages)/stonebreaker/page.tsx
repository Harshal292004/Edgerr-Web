...
import { Database, Home, Settings, Users, Plus, Code, Send, ChevronLeft, ChevronRight, ServerCrash } from 'lucide-react';
  ...
  return (
    <div className={`flex min-h-screen ${theme === "dark" ? "bg-gray-900" : "bg-gray-50"}`}>
        ...
        <div className="flex flex-col h-full">
          ...
          `}>
            {sidebarCollapsed ? (
              ...
              <h1 className={`
                text-xl font-bold ${space_mono.className}
                ${theme === "dark" 
          ...
          <nav className="flex-1 px-2 py-4 space-y-2 overflow-y-auto">
            {[
              ...
              { icon: <Code />, name: 'Queries' },
              { icon: <Users />, name: 'Team' },
              { icon: <Settings />, name: 'Settings' }
            ].map((item, index) => (
              <button key={index} className={`
                flex items-center ${sidebarCollapsed ? 'justify-center' : 'justify-start'} 
      ...
      `}>
        {/* Codd Hero */}
        <div className={`
          p-8 ${theme === "dark" ? "bg-gradient-to-r from-blue-900/30 to-purple-900/30" : "bg-gradient-to-r from-blue-50 to-purple-50"}
        `}>
          <h1 className={`
        ...
        <div className="p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-8">
            ...
            >
              ...
              `}>
                <Plus className={theme === "dark" ? "text-blue-400" : "text-blue-600"} />
              </div>
              ...
              >
                <div className="flex justify-between items-start mb-4">
                  ...
                  <span className={`
                    ...
                    ${theme === "dark" ? "bg-white/10 text-white" : "bg-black/10 text-gray-800"}
                  `}>
                    {db.tables} Tables
                  </span>
                </div>
            ...
            {databases.length === 0 && (
              <div className={`
                ...
                ${theme === "dark" 
                  ...
                  : "bg-white/60 border border-gray-200/50"}
              `}>
                <ServerCrash className={`mb-2 ${theme === "dark" ? "text-gray-400" : "text-gray-500"}`} />
              ...
              `}>
                ...
                <div className="flex justify-between items-center p-3 border-t bg-opacity-50 border-opacity-50 backdrop-blur-sm">
                  <div className={theme === "dark" ? "text-gray-400" : "text-gray-600"}>
                    <span className="text-xs">Try: "Create a table for users with email and password" or "Find all users who joined last month"</span>
                  </div>
                  <button
                    type="submit"
                    className={`
